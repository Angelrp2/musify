...
('admin', 'admin@musify.local', '$2y$10$abcdefghijklmnopqrstuvwxyz', 'Administrador de Musify', 'admin', 1),
('editor', 'editor@musify.local', '$2y$10$abcdefghijklmnopqrstuvwxyz', 'Editor de contenido', 'editor', 1),
('demo_user', 'demo@musify.local', '$2y$10$abcdefghijklmnopqrstuvwxyz', 'Usuario de demostración', 'user', 1),
('guest', 'guest@musify.local', '$2y$10$abcdefghijklmnopqrstuvwxyz', 'Usuario invitado', 'guest', 1);
